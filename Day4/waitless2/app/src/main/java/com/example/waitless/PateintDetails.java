...
public class PateintDetails extends AppCompatActivity {
    EditText etName, etGender, etAge, etNumber, etEmail, etSympotms, etDisease;
    Button btNext;
    ...
    public void NextAppointment(View view) {
        if (awesomeValidation.validate()) {
            ...
            Toast.makeText(getApplicationContext(), "Fill the form properly",Toast.LENGTH_SHORT).show();
        }
